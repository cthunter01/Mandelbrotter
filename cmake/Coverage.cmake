...
if(NOT MANDELBROTTER_BUILD_TESTS)
    message(FATAL_ERROR "MANDELBROTTER_ENABLE_COVERAGE needs MANDELBROTTER_BUILD_TESTS=ON")
endif()
...
set(coverage_targets Mandelbrotter_tests Mandelbrotter)
